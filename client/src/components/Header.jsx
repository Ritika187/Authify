...
const Header = () => {
  const {userData} = useContext(AppContext);
    return (
        <div className="text-center d-flex flex-column align-items-center justify-content-center py-5 px-3" style={{minHeight:"80vvh"}}>
              <img src={assets.header2} alt="header" width={170} className="mb-2" />
